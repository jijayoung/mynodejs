...
//     let sql = `select id, title, author, createdAt, count from posts order by createdAt desc`;
...
app.get("/posts", (req, res) => {
    ...
    const limit = 5; //페이지당 게시글
    const offset = (page - 1) * limit; //page :1 offset:0 ,page:2 offset:5,
...
//body -> row >json {"title":"update title","content" : "update content"}
...
app.delete("/posts/:id", (req, res) => {
    ...
    db.run(sql, [id], (err) => {
        ...
        res.json({ result: `id: ${id} ,delete suceess` })
    })
})
